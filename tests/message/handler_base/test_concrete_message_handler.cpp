...
#include "detail/test_payload_handler.h"
...
BOOST_AUTO_TEST_SUITE(concrete_message_handler_suite)
    ...
    {
        const celeritas::test_payload_handler handler{};
    ...
    {
        celeritas::test_payload_handler handler{};
    ...
    BOOST_AUTO_TEST_CASE(test_concrete_message_handler_function_management)
    {
        ...
        handler.add_handler_function(test_payload_case, &celeritas::test_payload_handler::handler);

        BOOST_CHECK(handler.has_handler_function(test_payload_case));
        BOOST_CHECK_NO_THROW(get_handler_func());
        BOOST_CHECK_EQUAL(handler.get_handler_function(test_payload_case), &celeritas::test_payload_handler::handler);
    }
