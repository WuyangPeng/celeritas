...
BOOST_AUTO_TEST_SUITE(properties_data_suite)
    ...
    BOOST_AUTO_TEST_CASE(test_document_value_accessors)
    {
        ...
        celeritas::properties_data::document_type test_value; // 默认构造
    ...
    {
        celeritas::properties_data data;
        const celeritas::properties_data::document_array_type test_value = {}; // 空数组作为测试
    ...
    {
        // 创建一个文档
        celeritas::properties_data::document_type doc; // 默认构造
        
        // 调用静态方法
        const auto data = celeritas::properties_data::from_document(doc);
