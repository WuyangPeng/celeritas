...
namespace
{
    ...
    [[nodiscard]] const celeritas::basis_database& get_field_value(const celeritas::properties_data::document_type& document, std::string_view field_name)
    {
    ...
    void verify_document_data(const celeritas::properties_data::document_type& document, const celeritas::properties_data& original_data)
    {
        BOOST_CHECK_EQUAL(get_field_value(document, celeritas::properties_data::int64_value_description).get_value<celeritas::database_data_type::int64_type>(),
        ...
        BOOST_CHECK(get_field_value(document, celeritas::properties_data::document_array_value_description).get_value<celeritas::database_data_type::document_array_type>() == original_data.get_document_array_value());
    }
}

BOOST_AUTO_TEST_SUITE(properties_data_suite)

    BOOST_AUTO_TEST_CASE(test_default_constructor)
    {
        const celeritas::properties_data data{};
    ...
    {
        celeritas::properties_data data{};
        const celeritas::properties_data::string_array_type test_value{ "item1", "item2", "item3" };
    ...
    {
        celeritas::properties_data data{};
        const celeritas::properties_data::int32_array_type test_value{ 10, 20, 30, 40 };
    ...
    {
        celeritas::properties_data data{};
        const celeritas::properties_data::int64_array_type test_value{ 100LL, 200LL, 300LL };
    ...
    BOOST_AUTO_TEST_CASE(test_document_value_accessors)
    {
        ...
        const celeritas::properties_data::document_type test_value{ celeritas::basis_database{ "int_field", 12345 },
    ...
    {
        const celeritas::properties_data::document_type doc1{ celeritas::basis_database{ "field1", 1 },
                                                              celeritas::basis_database{ "field2", "value1" } };

        const celeritas::properties_data::document_type doc2{ celeritas::basis_database{ "field3", 2 },
                                                              celeritas::basis_database{ "field4", "value2" } };

        const celeritas::properties_data::document_array_type test_value{ doc1, doc2 };
    ...
    {
        const auto original_data = get_test_properties_data();
    ...
    BOOST_AUTO_TEST_CASE(test_from_document)
    {
        ...
        const auto loaded_data = celeritas::properties_data::from_document(document);

        check_properties_data(original_data, loaded_data);
    }
