...
celeritas::concurrent_access_tester::concurrent_access_tester(boost::asio::io_context& io_context)
...
void celeritas::concurrent_access_tester::run()
{
    ...
    {
        boost::asio::co_spawn(io_context_, check_time_refresh_task(),
...
celeritas::concurrent_access_tester::void_awaitable_type celeritas::concurrent_access_tester::wait()
{
    ...
    {
        co_await boost::asio::steady_timer(io_context_, std::chrono::milliseconds{ 1 }).async_wait(boost::asio::use_awaitable);
    }
