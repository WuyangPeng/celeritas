...
namespace
{
    ...
    [[nodiscard]] boost::asio::awaitable<void> test_select_one(const celeritas::mongo_database_session_fixture& fixture,
                                                               const std::string& expected_chapter_name,
                                                               const int64_t expected_currency)
    {
        const auto session = fixture.get_session();
    ...
    void check_mongo_test(const celeritas::mongo_test& lhs, const celeritas::mongo_test& rhs)
    {
