...
void celeritas::mock_resource_loader::process_check_tcp_clients_by_duration(const any_io_executor& any_io_executor)
{
}
...
celeritas::resource_loader_base::health_check_level_awaitable_type celeritas::mock_resource_loader::get_health_check_level() const
{
...
void celeritas::mock_resource_loader::check_client(const any_io_executor& any_io_executor, const std::string& server_type, const service_info_container& container)
{
}
