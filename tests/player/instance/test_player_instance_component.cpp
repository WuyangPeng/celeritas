...
namespace
{
    struct player_instance_component_fixture
    {
        ...
        std::shared_ptr<celeritas::player_instance_component> component_;
    };
}

BOOST_FIXTURE_TEST_SUITE(player_instance_component_suite, player_instance_component_fixture)

    BOOST_AUTO_TEST_CASE(test_get_player_component_type)
    {
        BOOST_CHECK_EQUAL(static_cast<int>(component_->get_player_component_type()), static_cast<int>(celeritas::player_component_type::instance));
        BOOST_CHECK_EQUAL(static_cast<int>(celeritas::player_instance_component::get_player_component_type()), static_cast<int>(celeritas::player_component_type::instance));
    }
