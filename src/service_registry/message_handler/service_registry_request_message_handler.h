...
namespace celeritas
{
    ...
    private:
        [[nodiscard]] bool handle_server_register(const header& header, const message_type& current_message, const protobuf_message_shared_ptr& request_message, const message_registry_shared_ptr& message_registry);

        [[nodiscard]] bool handle_server_discover(const header& header, const message_type& current_message, const protobuf_message_shared_ptr& request_message, const message_registry_shared_ptr& message_registry);
    };
}
