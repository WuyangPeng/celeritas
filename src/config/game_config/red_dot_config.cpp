#include "red_dot_config.h"

celeritas::red_dot_config::red_dot_config(const red_dot_type id, std::string name, const red_dot_type parent_node_id, const red_dot_status_type red_dot_status_type, bool save_database)
...
std::string celeritas::red_dot_config::get_name() const
{
    return name_;
}
...
bool celeritas::red_dot_config::is_save_database() const
{
