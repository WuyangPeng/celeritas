...
void celeritas::logger_level_config::set_default_level(severity_level_type severity_level_type)
{
    default_level_ = severity_level_type;
    is_set_default_level_ = true;
}

void celeritas::logger_level_config::set_console_level(severity_level_type severity_level_type)
{
