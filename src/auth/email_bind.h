...
namespace celeritas
{
    ...
    private:
        ...
        [[nodiscard]] static std::string calculate_hmac_sha256(int app_id, const std::string& email, const std::string& device_id, int code, int64_t timestamp, const std::string& secret_key);
