...
celeritas::auth_service_base::auth_service_base(http_handle_parameter_shared_ptr handle_parameter)
...
celeritas::auth_service_base::http_handle_parameter_shared_ptr celeritas::auth_service_base::get_http_handle_parameter() const
{
