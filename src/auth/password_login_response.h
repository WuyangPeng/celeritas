...
namespace celeritas
{
    ...
    public:
        ...
        password_login_response(game_error_type code, std::string message, std::string token, int64_t expire_milliseconds);
    ...
    [[nodiscard]] password_login_response tag_invoke(password_login_response_tag, const http_response::json_value& value);

    void tag_invoke(boost::json::value_from_tag tag, password_login_response::json_value& value, const password_login_response& password_login_response);
}