...
celeritas::guest_login::void_awaitable_type celeritas::guest_login::response()
{
    ...
    auto account = co_await get_account(optional_account, redis_pool, app_id, device_id, handle_parameter_.get_app_config());
...
std::string celeritas::guest_login::generate_token()
{
