...
celeritas::phone_bind::void_awaitable_type celeritas::phone_bind::response()
{
    ...
    account_bind_select->add_key(basis_database{ account_bind::account_type_describe, static_cast<int>(account_type::phone) });
    account_bind_select->add_key(basis_database{ account_bind::auth_key_describe, phone });
