...
celeritas::email_operation_parameter::optional_email_code_awaitable_type celeritas::email_operation_parameter::check_code(const database_pool_shared_ptr& redis_pool, ServiceBaseType& auth_service_base) const
{
