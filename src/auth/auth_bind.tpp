                                                                                        ...
                                                                                        const database_pool_shared_ptr& mysql_pool) const
{
    ...
    const auto optional_account = co_await mysql_pool->select_one(account::get_select(database_type::mysql, session_token.get_account_id()), account::get_database_field_container());
