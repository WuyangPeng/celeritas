...
#include "network/listener/listener_accept.h"
...
namespace celeritas
{
    ...
    public:
        ...
        http_listener_accept(acceptor_type& acceptor, server_network_type server_network_type, std::string game_server_id, network_message_callback_weak_ptr callback);
