...
celeritas::websocket_session_handle_session::websocket_session_handle_session(web_socket_stream_type& web_socket, long session_id, network_message_callback_weak_ptr callback)
