...
celeritas::tcp_client::tcp_client(io_context_type& io_context, network_message_callback_weak_ptr callback, std::string game_server_id, std::string server_type)
    : base_type{},
