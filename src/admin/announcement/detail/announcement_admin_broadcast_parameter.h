...
namespace celeritas
{
    class announcement_admin_broadcast_parameter final : public admin_parameter
    {
    public:
        using class_type = announcement_admin_broadcast_parameter;
        using base_type = admin_parameter;

        explicit announcement_admin_broadcast_parameter(const http_handle_parameter_shared_ptr& http_handle_parameter);
