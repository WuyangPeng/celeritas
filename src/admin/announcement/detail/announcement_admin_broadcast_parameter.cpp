...
#include "announcement_admin_broadcast_parameter.h"
...
celeritas::announcement_admin_broadcast_parameter::announcement_admin_broadcast_parameter(const http_handle_parameter_shared_ptr& http_handle_parameter)
    : base_type{ http_handle_parameter }, response_{}, id_{ 0 }, token_{}
{
    init();
}

bool celeritas::announcement_admin_broadcast_parameter::is_failure() const
{
    return response_.has_value();
}

celeritas::http_response celeritas::announcement_admin_broadcast_parameter::get_response() const
{
    return response_.value();
}

int64_t celeritas::announcement_admin_broadcast_parameter::get_id() const noexcept
{
    return id_;
}

const std::string& celeritas::announcement_admin_broadcast_parameter::get_token() const noexcept
{
    return token_;
}

void celeritas::announcement_admin_broadcast_parameter::init_required_parameter()
{
...
void celeritas::announcement_admin_broadcast_parameter::verify_sign()
{
