...
namespace celeritas
{
    class feedback_admin_list_parameter final : public admin_parameter
    {
    public:
        using class_type = feedback_admin_list_parameter;
        using base_type = admin_parameter;

        explicit feedback_admin_list_parameter(const http_handle_parameter_shared_ptr& http_handle_parameter);
