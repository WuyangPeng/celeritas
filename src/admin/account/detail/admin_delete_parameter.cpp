...
#include "admin_delete_parameter.h"
...
celeritas::admin_delete_parameter::admin_delete_parameter(const http_handle_parameter_shared_ptr& http_handle_parameter)
    : base_type{ http_handle_parameter }, response_{}, target_id_{ 0 }, token_{}
{
    init();
}

bool celeritas::admin_delete_parameter::is_failure() const
{
    return response_.has_value();
}

celeritas::http_response celeritas::admin_delete_parameter::get_response() const
{
    return response_.value();
}

int64_t celeritas::admin_delete_parameter::get_target_id() const noexcept
{
    return target_id_;
}

const std::string& celeritas::admin_delete_parameter::get_token() const noexcept
{
    return token_;
}

void celeritas::admin_delete_parameter::init_required_parameter()
{
...
void celeritas::admin_delete_parameter::verify_sign()
{
