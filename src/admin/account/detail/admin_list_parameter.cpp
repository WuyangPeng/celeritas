...
#include "admin_list_parameter.h"
...
celeritas::admin_list_parameter::admin_list_parameter(const http_handle_parameter_shared_ptr& http_handle_parameter)
    : base_type{ http_handle_parameter }, response_{}, page_{ 0 }, page_size_{ 0 }, token_{}
{
    init();
}

bool celeritas::admin_list_parameter::is_failure() const
{
    return response_.has_value();
}

celeritas::http_response celeritas::admin_list_parameter::get_response() const
{
    return response_.value();
}

int celeritas::admin_list_parameter::get_page() const noexcept
{
    return page_;
}

int celeritas::admin_list_parameter::get_page_size() const noexcept
{
    return page_size_;
}

const std::string& celeritas::admin_list_parameter::get_token() const noexcept
{
    return token_;
}

void celeritas::admin_list_parameter::init_required_parameter()
{
...
void celeritas::admin_list_parameter::verify_sign()
{
