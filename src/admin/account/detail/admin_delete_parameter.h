...
namespace celeritas
{
    class admin_delete_parameter final : public admin_parameter
    {
    public:
        using class_type = admin_delete_parameter;
        using base_type = admin_parameter;

        explicit admin_delete_parameter(const http_handle_parameter_shared_ptr& http_handle_parameter);
