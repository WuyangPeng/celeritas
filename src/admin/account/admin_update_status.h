...
namespace celeritas
{
    class admin_update_status final : public admin_service_base
    {
    public:
        using class_type = admin_update_status;
        using base_type = admin_service_base;

        explicit admin_update_status(http_handle_parameter_shared_ptr handle_parameter);
    ...
    private:
        ...
        [[nodiscard]] static bool_awaitable_type update_status(const database_pool_shared_ptr& mysql_pool,
