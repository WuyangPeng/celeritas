...
celeritas::sdk_payment_providers::basis_database_container_const_shared_ptr celeritas::sdk_payment_providers::get_key_basis_database_container(traits::param_type::int64_type sdk_id)
{
