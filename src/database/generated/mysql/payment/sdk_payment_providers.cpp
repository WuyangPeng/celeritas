...
celeritas::sdk_payment_providers::const_database_entity_change_shared_ptr celeritas::sdk_payment_providers::get_select(const database_type database_type)
{
...
celeritas::sdk_payment_providers::const_database_entity_change_shared_ptr celeritas::sdk_payment_providers::get_select(const database_type database_type, traits::param_type::int64_type sdk_id)
{
...
celeritas::sdk_payment_providers::const_database_entity_change_shared_ptr celeritas::sdk_payment_providers::get_select(const database_type database_type, const const_basis_database_container_shared_ptr& key)
{
    return std::make_shared<database_entity_change>(database_type,
                                                    database_name,
                                                    database_change_type::select_type,
...
celeritas::sdk_payment_providers::const_basis_database_container_shared_ptr celeritas::sdk_payment_providers::get_key_basis_database_container(traits::param_type::int64_type sdk_id)
{
