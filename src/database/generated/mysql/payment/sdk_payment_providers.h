...
namespace celeritas
{
    class sdk_payment_providers final : public database_entity
    {
    public:
        using class_type = sdk_payment_providers;
        using base_type = database_entity;

        explicit sdk_payment_providers(const database_entity_change& entity);

        sdk_payment_providers(database_type database_type, const database_entity_change& entity);

        sdk_payment_providers(database_type database_type, traits::param_type::int64_type sdk_id);
