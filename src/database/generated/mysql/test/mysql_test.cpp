...
celeritas::traits::string_array_type celeritas::mysql_test::get_tags() const
{
    return tags_.get_value();
}

celeritas::traits::int32_array_type celeritas::mysql_test::get_category_index() const
{
    return category_index_.get_value();
}

celeritas::traits::int64_array_type celeritas::mysql_test::get_related_index() const
{
...
celeritas::traits::document_array_type celeritas::mysql_test::get_logs() const
{
...
void celeritas::mysql_test::set_tags(traits::param_type::string_array_type tags)
{
    if (tags != get_tags())
    {
...
void celeritas::mysql_test::set_category_index(traits::param_type::int32_array_type category_index)
{
...
void celeritas::mysql_test::set_related_index(traits::param_type::int64_array_type related_index)
{
...
void celeritas::mysql_test::set_ratios(traits::param_type::double_array_type ratios)
{
...
void celeritas::mysql_test::set_properties(traits::param_type::document_type properties)
{
...
void celeritas::mysql_test::set_logs(traits::param_type::document_array_type logs)
{
    if (logs != get_logs())
    {
...
void celeritas::mysql_test::set_tags(const int index, traits::param_type::string_array_element_type tags)
{
...
void celeritas::mysql_test::add_tags(traits::param_type::string_array_element_type tags)
{
...
void celeritas::mysql_test::remove_tags(const int index)
{
...
void celeritas::mysql_test::set_category_index(const int index, traits::param_type::int32_array_element_type category_index)
{
...
void celeritas::mysql_test::add_category_index(traits::param_type::int32_array_element_type category_index)
{
...
void celeritas::mysql_test::remove_category_index(const int index)
{
...
void celeritas::mysql_test::set_related_index(const int index, traits::param_type::int64_array_element_type related_index)
{
...
void celeritas::mysql_test::add_related_index(traits::param_type::int64_array_element_type related_index)
{
...
void celeritas::mysql_test::remove_related_index(const int index)
{
...
void celeritas::mysql_test::set_ratios(const int index, traits::param_type::double_array_element_type ratios)
{
...
void celeritas::mysql_test::add_ratios(traits::param_type::double_array_element_type ratios)
{
...
void celeritas::mysql_test::remove_ratios(const int index)
{
...
void celeritas::mysql_test::add_logs(traits::param_type::document_array_element_type logs)
{
...
void celeritas::mysql_test::remove_logs(const int index)
{
