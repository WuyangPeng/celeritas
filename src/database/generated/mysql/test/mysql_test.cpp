...
celeritas::traits::int32_array_type celeritas::mysql_test::get_category_ids() const
{
    return category_ids_.get_value();
}

celeritas::traits::int64_array_type celeritas::mysql_test::get_related_ids() const
{
...
void celeritas::mysql_test::set_category_ids(traits::param_type::int32_array_type category_ids)
{
...
void celeritas::mysql_test::set_related_ids(traits::param_type::int64_array_type related_ids)
{
...
void celeritas::mysql_test::set_category_ids(const int index, traits::param_type::int32_array_element_type category_ids)
{
...
void celeritas::mysql_test::add_category_ids(traits::param_type::int32_array_element_type category_ids)
{
...
void celeritas::mysql_test::remove_category_ids(const int index)
{
...
void celeritas::mysql_test::set_related_ids(const int index, traits::param_type::int64_array_element_type related_ids)
{
...
void celeritas::mysql_test::add_related_ids(traits::param_type::int64_array_element_type related_ids)
{
...
void celeritas::mysql_test::remove_related_ids(const int index)
{
