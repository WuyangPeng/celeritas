...
namespace celeritas
{
    ...
    public:
        ...
        [[nodiscard]] traits::int32_type get_permission() const noexcept;
        ...
        void set_permission(traits::param_type::int32_type permission);
        ...
        static constexpr std::string_view permission_describe{ "permission" };
    ...
    private:
        ...
        entity<permission_describe, database_data_type::int32_type> permission_;
    };
}