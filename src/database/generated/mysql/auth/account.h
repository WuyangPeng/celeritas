...
namespace celeritas
{
    ...
    public:
        ...
        account(database_type database_type, const database_entity_change& entity);
    ...
    private:
        ...
        entity<device_id_describe, database_data_type::string_type, database_index_type::composite_unique_index> device_id_;
