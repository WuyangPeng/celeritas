...
celeritas::apps::apps(const database_entity_change& entity)
    : base_type{ entity.get_database_entity_change(app_id_describe)  },
...
celeritas::apps::apps(const database_type database_type, const database_entity_change& entity)
    : base_type{ database_type, entity.get_database_entity_change(app_id_describe) },
      app_id_{ entity.get_value<database_data_type::int64_type>(app_id_describe) },
      game_name_{ entity.get_value<database_data_type::string_type>(game_name_describe) },
      app_secret_{ entity.get_value<database_data_type::string_type>(app_secret_describe) },
      app_payment_secret_{ entity.get_value<database_data_type::string_type>(app_payment_secret_describe) },
...
celeritas::apps::const_database_entity_change_shared_ptr celeritas::apps::get_select(const database_type database_type)
{
...
celeritas::apps::const_database_entity_change_shared_ptr celeritas::apps::get_select(const database_type database_type, traits::param_type::int64_type app_id)
{
...
celeritas::apps::const_database_entity_change_shared_ptr celeritas::apps::get_select(const database_type database_type, const const_basis_database_container_shared_ptr& key)
{
    return std::make_shared<database_entity_change>(database_type,
                                                    database_name,
                                                    database_change_type::select_type,
...
celeritas::apps::const_basis_database_container_shared_ptr celeritas::apps::get_key_basis_database_container(traits::param_type::int64_type app_id)
{
