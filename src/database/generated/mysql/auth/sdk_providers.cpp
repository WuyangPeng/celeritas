...
celeritas::traits::int64_type celeritas::sdk_providers::get_sdk_id() const noexcept
{
    return sdk_id_.get_value();
}

celeritas::traits::int64_type celeritas::sdk_providers::get_app_id() const noexcept
{
    return app_id_.get_value();
}

celeritas::traits::int32_type celeritas::sdk_providers::get_process_type() const noexcept
{
    return process_type_.get_value();
}

celeritas::traits::string_type celeritas::sdk_providers::get_provider_name() const
{
    return provider_name_.get_value();
}

celeritas::traits::string_type celeritas::sdk_providers::get_base_url() const
{
    return base_url_.get_value();
}

celeritas::traits::string_type celeritas::sdk_providers::get_api_key() const
{
    return api_key_.get_value();
}

celeritas::traits::string_type celeritas::sdk_providers::get_api_secret() const
{
    return api_secret_.get_value();
}

celeritas::traits::string_type celeritas::sdk_providers::get_decryption_key() const
{
    return decryption_key_.get_value();
}

celeritas::traits::bool_type celeritas::sdk_providers::is_active() const noexcept
{
    return active_.get_value();
}

void celeritas::sdk_providers::set_sdk_id(traits::param_type::int64_type sdk_id)
{
...
void celeritas::sdk_providers::set_app_id(traits::param_type::int64_type app_id)
{
...
void celeritas::sdk_providers::set_process_type(traits::param_type::int32_type process_type)
{
...
void celeritas::sdk_providers::set_provider_name(traits::param_type::string_type provider_name)
{
...
void celeritas::sdk_providers::set_base_url(traits::param_type::string_type base_url)
{
...
void celeritas::sdk_providers::set_api_key(traits::param_type::string_type api_key)
{
...
void celeritas::sdk_providers::set_api_secret(traits::param_type::string_type api_secret)
{
...
void celeritas::sdk_providers::set_decryption_key(traits::param_type::string_type decryption_key)
{
...
void celeritas::sdk_providers::set_active(traits::param_type::bool_type active)
{
    if (active != is_active())
    {
...
const celeritas::database_entity::database_field_container& celeritas::sdk_providers::get_database_field_container()
{
...
celeritas::sdk_providers::const_database_entity_change_shared_ptr celeritas::sdk_providers::get_select(const database_type database_type)
{
...
celeritas::sdk_providers::const_database_entity_change_shared_ptr celeritas::sdk_providers::get_select(const database_type database_type, traits::param_type::int64_type sdk_id)
{
...
celeritas::sdk_providers::const_database_entity_change_shared_ptr celeritas::sdk_providers::get_select(const database_type database_type, const const_basis_database_container_shared_ptr& key)
{
    return std::make_shared<database_entity_change>(database_type,
                                                    database_name,
                                                    database_change_type::select_type,
...
celeritas::sdk_providers::const_basis_database_container_shared_ptr celeritas::sdk_providers::get_key_basis_database_container(traits::param_type::int64_type sdk_id)
{
