...
{
    const auto field_name = database_type == database_type::mongo ? "_id" : cell_id_describe;

    const auto container = std::make_shared<basis_database_container>(basis_database{ field_name, cell_id });
