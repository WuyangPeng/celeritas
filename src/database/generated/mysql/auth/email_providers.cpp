...
celeritas::email_providers::email_providers(const database_entity_change& entity)
    : base_type{ entity },
      provider_id_{ entity.get_value<database_data_type::int64_type>(entity.get_database_type() == database_type::mongo ? "_id" : provider_id_describe) },
...
celeritas::email_providers::email_providers(const database_type database_type, traits::param_type::int64_type provider_id)
...
celeritas::traits::int64_type celeritas::email_providers::get_provider_id() const noexcept
{
    return provider_id_.get_value();
}

celeritas::traits::string_type celeritas::email_providers::get_provider_name() const
{
    return provider_name_.get_value();
}

celeritas::traits::string_type celeritas::email_providers::get_base_url() const
{
    return base_url_.get_value();
}

celeritas::traits::string_type celeritas::email_providers::get_api_key() const
{
    return api_key_.get_value();
}

celeritas::traits::string_type celeritas::email_providers::get_api_secret() const
{
    return api_secret_.get_value();
}

celeritas::traits::string_type celeritas::email_providers::get_decryption_key() const
{
    return decryption_key_.get_value();
}

celeritas::traits::bool_type celeritas::email_providers::is_active() const noexcept
{
    return active_.get_value();
}

celeritas::traits::int32_type celeritas::email_providers::get_process_type() const noexcept
{
    return process_type_.get_value();
}

void celeritas::email_providers::set_provider_id(traits::param_type::int64_type provider_id)
{
...
void celeritas::email_providers::set_provider_name(traits::param_type::string_type provider_name)
{
...
void celeritas::email_providers::set_base_url(traits::param_type::string_type base_url)
{
...
void celeritas::email_providers::set_api_key(traits::param_type::string_type api_key)
{
...
void celeritas::email_providers::set_api_secret(traits::param_type::string_type api_secret)
{
...
void celeritas::email_providers::set_decryption_key(traits::param_type::string_type decryption_key)
{
...
void celeritas::email_providers::set_active(traits::param_type::bool_type active)
{
    if (active != is_active())
    {
...
void celeritas::email_providers::set_process_type(traits::param_type::int32_type process_type)
{
...
const celeritas::database_entity::database_field_container& celeritas::email_providers::get_database_field_container()
{
...
celeritas::email_providers::database_entity_change_const_shared_ptr celeritas::email_providers::get_select(const database_type database_type, traits::param_type::int64_type provider_id)
{
...
celeritas::email_providers::database_entity_change_const_shared_ptr celeritas::email_providers::get_select(const database_type database_type, const basis_database_container_const_shared_ptr& key)
{
    return std::make_shared<database_entity_change>(database_type,
                                                    database_name,
                                                    database_change_type::select_type,
...
celeritas::email_providers::basis_database_container_const_shared_ptr celeritas::email_providers::get_key_basis_database_container(const database_type database_type, traits::param_type::int64_type provider_id)
{
    const auto field_name = database_type == database_type::mongo ? "_id" : provider_id_describe;

    const auto container = std::make_shared<basis_database_container>(basis_database{ field_name, provider_id });
