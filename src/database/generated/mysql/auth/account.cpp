...
celeritas::account::basis_database_container_const_shared_ptr celeritas::account::get_key_basis_database_container(traits::param_type::int64_type account_id)
{
