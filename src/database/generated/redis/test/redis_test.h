...
namespace celeritas
{
    class redis_test final : public database_entity
    {
    public:
        using class_type = redis_test;
        using base_type = database_entity;

        explicit redis_test(const database_entity_change& entity);

        redis_test(database_type database_type, const database_entity_change& entity);

        redis_test(database_type database_type, traits::param_type::int64_type user_id);
        ...
        static constexpr std::string_view database_name{ "redis_test" };
