...
celeritas::user_role::basis_database_container_const_shared_ptr celeritas::user_role::get_key_basis_database_container(traits::param_type::int64_type user_id)
{
