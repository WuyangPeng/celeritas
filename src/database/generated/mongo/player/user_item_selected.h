...
namespace celeritas
{
    class user_item_selected final : public database_entity
    {
    public:
        using class_type = user_item_selected;
        using base_type = database_entity;

        explicit user_item_selected(const database_entity_change& entity);

        user_item_selected(database_type database_type, const database_entity_change& entity);

        user_item_selected(database_type database_type, traits::param_type::int64_type user_id);
        ...
        void set_item_selected_data(traits::param_type::document_array_type item_selected_data);
        ...
        void set_item_selected_data(int index, traits::param_type::document_array_element_type item_selected_data);

        void add_item_selected_data(traits::param_type::document_array_element_type item_selected_data);

        void remove_item_selected_data(int index);
        ...
        static constexpr std::string_view database_name{ "user_item_selected" };

        static constexpr std::string_view user_id_describe{ "_id" };
        static constexpr std::string_view item_selected_data_describe{ "item_selected_data" };
    ...
    private:
        ...
        entity<item_selected_data_describe, database_data_type::document_array_type> item_selected_data_;
