...
namespace celeritas
{
    class user_develop final : public database_entity
    {
    public:
        using class_type = user_develop;
        using base_type = database_entity;

        explicit user_develop(const database_entity_change& entity);

        user_develop(database_type database_type, const database_entity_change& entity);

        user_develop(database_type database_type, traits::param_type::int64_type user_id);
        ...
        void set_develop_data(traits::param_type::document_array_type develop_data);
        ...
        void set_develop_data(int index, traits::param_type::document_array_element_type develop_data);

        void add_develop_data(traits::param_type::document_array_element_type develop_data);

        void remove_develop_data(int index);
        ...
        static constexpr std::string_view database_name{ "user_develop" };

        static constexpr std::string_view user_id_describe{ "_id" };
        static constexpr std::string_view develop_data_describe{ "develop_data" };
    ...
    private:
        ...
        entity<develop_data_describe, database_data_type::document_array_type> develop_data_;
