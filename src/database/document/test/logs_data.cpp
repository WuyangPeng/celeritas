...
const std::string& celeritas::logs_data::get_string_val() const
{
    return string_val_;
}

void celeritas::logs_data::set_string_val(std::string string_val)
{
    string_val_ = std::move(string_val);
}

const std::vector<std::string>& celeritas::logs_data::get_string_array_val() const
{
    return string_array_val_;
}

void celeritas::logs_data::set_string_array_val(std::vector<std::string> string_array_val)
{
    string_array_val_ = std::move(string_array_val);
}

int32_t celeritas::logs_data::get_int32_val() const
{
    return int32_val_;
}

void celeritas::logs_data::set_int32_val(const int32_t int32_val)
{
    int32_val_ = int32_val;
}

int32_t celeritas::logs_data::get_int32_count_val() const
{
    return int32_count_val_;
}

void celeritas::logs_data::set_int32_count_val(const int32_t int32_count_val)
{
    int32_count_val_ = int32_count_val;
}

const std::vector<int32_t>& celeritas::logs_data::get_int32_array_val() const
{
    return int32_array_val_;
}

void celeritas::logs_data::set_int32_array_val(std::vector<int32_t> int32_array_val)
{
    int32_array_val_ = std::move(int32_array_val);
}

int64_t celeritas::logs_data::get_int64_count_val() const
{
    return int64_count_val_;
}

void celeritas::logs_data::set_int64_count_val(const int64_t int64_count_val)
{
    int64_count_val_ = int64_count_val;
}

const std::vector<int64_t>& celeritas::logs_data::get_int64_array_val() const
{
    return int64_array_val_;
}

void celeritas::logs_data::set_int64_array_val(std::vector<int64_t> int64_array_val)
{
    int64_array_val_ = std::move(int64_array_val);
}

double celeritas::logs_data::get_double_val() const
{
    return double_val_;
}

void celeritas::logs_data::set_double_val(const double double_val)
{
    double_val_ = double_val;
}

const std::vector<double>& celeritas::logs_data::get_double_array_val() const
{
    return double_array_val_;
}

void celeritas::logs_data::set_double_array_val(std::vector<double> double_array_val)
{
    double_array_val_ = std::move(double_array_val);
}

bool celeritas::logs_data::get_bool_val() const
{
    return bool_val_;
}

void celeritas::logs_data::set_bool_val(bool bool_val)
{
    bool_val_ = bool_val;
}

const celeritas::logs_data::document_type& celeritas::logs_data::get_document_val() const
{
    return document_val_;
}

void celeritas::logs_data::set_document_val(document_type document_val)
{
    document_val_ = std::move(document_val);
}

const celeritas::traits::document_array_type& celeritas::logs_data::get_document_array_val() const
{
    return document_array_val_;
}

void celeritas::logs_data::set_document_array_val(traits::document_array_type document_array_val)
{
...
celeritas::logs_data celeritas::logs_data::from_document(const document_type& document)
{
    ...
    for (const auto& element : document)
    {
        ...
        {
            logs_data.set_string_val(element.get_value<database_data_type::string_type>());
        }
        else if (element.get_field_name() == string_array_val_description)
        {
            logs_data.set_string_array_val(element.get_value<database_data_type::string_array_type>());
        }
        ...
        {
            logs_data.set_int64_count_val(element.get_value<database_data_type::int64_count_type>());
        }
        else if (element.get_field_name() == int64_array_val_description)
        {
            logs_data.set_int64_array_val(element.get_value<database_data_type::int64_array_type>());
        }
        else if (element.get_field_name() == double_val_description)
        {
            logs_data.set_double_val(element.get_value<database_data_type::double_type>());
        }
        else if (element.get_field_name() == double_array_val_description)
        {
            logs_data.set_double_array_val(element.get_value<database_data_type::double_array_type>());
        }
        else if (element.get_field_name() == bool_val_description)
        {
            logs_data.set_bool_val(element.get_value<database_data_type::bool_type>());
        }
        else if (element.get_field_name() == document_val_description)
        {
            logs_data.set_document_val(element.get_value<database_data_type::document_type>());
        }
        else if (element.get_field_name() == document_array_val_description)
        {
            logs_data.set_document_array_val(element.get_value<database_data_type::document_array_type>());
        }
    }
