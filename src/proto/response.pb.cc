...
static constexpr const ::_pb::EnumDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_enum_descriptors_proto_2fresponse_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_service_descriptors_proto_2fresponse_2eproto = nullptr;
const ::uint32_t
    TableStruct_proto_2fresponse_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x004, // bitmap
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::celeritas::proto::response)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::celeritas::proto::_response_default_instance_._instance,
};
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_proto_2fresponse_2eproto = {
    ...
    TableStruct_proto_2fresponse_2eproto::offsets,
    file_level_enum_descriptors_proto_2fresponse_2eproto,
    file_level_service_descriptors_proto_2fresponse_2eproto,
};
namespace celeritas {
namespace proto {
// ===================================================================
...
class response::_Internal {
 public:
  static constexpr ::int32_t kOneofCaseOffset =
      PROTOBUF_FIELD_OFFSET(::celeritas::proto::response, _impl_._oneof_case_);
};

void response::set_allocated_service(::celeritas::proto::service::service_response* PROTOBUF_NULLABLE service) {
  ...
  // @@protoc_insertion_point(field_set_allocated:celeritas.proto.response.service)
}
void response::clear_service() {
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:celeritas.proto.response)
}
PROTOBUF_NDEBUG_INLINE response::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::celeritas::proto::response& from_msg)
      : payload_{},
        _cached_size_{0},
...
response::response(
  ...
  // @@protoc_insertion_point(copy_constructor:celeritas.proto.response)
}
PROTOBUF_NDEBUG_INLINE response::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
response::~response() {
  // @@protoc_insertion_point(destructor:celeritas.proto.response)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(one_of_clear_start:celeritas.proto.response)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  switch (payload_case()) {
    case kService: {
      if (GetArena() == nullptr) {
...
response::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::celeritas::proto::response>(),  // to_prefetch
    ...
    {PROTOBUF_FIELD_OFFSET(response, _impl_.payload_.service_), _Internal::kOneofCaseOffset + 0, 0,
...
// @@protoc_insertion_point(message_clear_start:celeritas.proto.response)
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
::uint8_t* PROTOBUF_NONNULL response::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:celeritas.proto.response)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:celeritas.proto.response)
  return target;
}
...
::size_t response::ByteSizeLong() const {
  const response& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:celeritas.proto.response)
  ::size_t total_size = 0;
...
void response::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:celeritas.proto.response)
...
// @@protoc_insertion_point(class_specific_copy_from_start:celeritas.proto.response)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_proto_2fresponse_2eproto),
         ::std::false_type{});
