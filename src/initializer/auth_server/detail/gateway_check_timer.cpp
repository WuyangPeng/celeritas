...
celeritas::gateway_check_timer::gateway_check_timer(const any_io_executor& any_io_executor, const duration_type interval, resource_loader_weak_ptr resource_loader, network_message_callback_weak_ptr network_message_callback)
...
void celeritas::gateway_check_timer::execute_timer_task()
{
    ...
    {
        resource_loader_shared_ptr->send_gateway_check();
    }
}