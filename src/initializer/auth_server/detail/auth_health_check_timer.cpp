...
celeritas::auth_health_check_timer::auth_health_check_timer(io_context_type& io_context, const duration_type interval, resource_loader_weak_ptr resource_loader, network_message_callback_weak_ptr network_message_callback)
