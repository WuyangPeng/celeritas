...
namespace celeritas
{
    ...
    public:
        ...
        explicit auth_health_check_timer(const any_io_executor& any_io_executor, duration_type interval, resource_loader_weak_ptr resource_loader, network_message_callback_weak_ptr network_message_callback);
