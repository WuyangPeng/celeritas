...
namespace celeritas
{
    class gateway_check_timer final : public timer_base
    {
    public:
        using class_type = gateway_check_timer;
        ...
        explicit gateway_check_timer(const any_io_executor& any_io_executor, duration_type interval, resource_loader_weak_ptr resource_loader, network_message_callback_weak_ptr network_message_callback);
