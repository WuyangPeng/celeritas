...
void celeritas::register_handler_helper::register_handler() const
{
    ...
    message_registry_->register_handler(std::make_shared<payment_request_message_handler>());
    message_registry_->register_handler(std::make_shared<payment_response_message_handler>());
