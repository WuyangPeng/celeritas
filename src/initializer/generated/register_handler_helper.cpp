...
void celeritas::register_handler_helper::register_handler() const
{
    ...
    message_registry_->registerHandler(std::make_shared<reload_email_providers_db_message_handler>());
    message_registry_->registerHandler(std::make_shared<reload_sdk_providers_db_message_handler>());
    message_registry_->registerHandler(std::make_shared<reload_sms_providers_db_message_handler>());
    ...
    http_message_registry_->registerHandler(std::make_shared<email_bind_http_message_handler>());
    http_message_registry_->registerHandler(std::make_shared<email_login_http_message_handler>());
    http_message_registry_->registerHandler(std::make_shared<guest_login_http_message_handler>());
    http_message_registry_->registerHandler(std::make_shared<password_bind_http_message_handler>());
    ...
    http_message_registry_->registerHandler(std::make_shared<order_create_http_message_handler>());
