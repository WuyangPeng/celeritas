...
{
    const auto client = std::make_shared<tcp_client>(io_context, network_message_callback, game_server_id, service_registry_config.get_name(), service_registry_config.get_host(), service_registry_config.get_port(), server_type);
