...
{
    return message_registry_->dispatch(protobuf_handle_parameter{ io_context, header, request_message, session, resource_loader, shared_from_this() }, current_message);
}
