...
celeritas::refund_notify::refund_notify_unique_ptr celeritas::refund_notify::create(sdk_payment_providers_key sdk_payment_providers_key, http_handle_parameter_shared_ptr handle_parameter)
{
