...
celeritas::recharge_notify::recharge_notify(sdk_payment_providers sdk_payment_providers, http_handle_parameter handle_parameter)
    : sdk_payment_providers_{ std::move(sdk_payment_providers) }, handle_parameter_{ std::move(handle_parameter) }
{
}

celeritas::recharge_notify::recharge_notify_unique_ptr celeritas::recharge_notify::create(sdk_payment_providers_key sdk_payment_providers_key, http_handle_parameter handle_parameter)
{
