...
namespace celeritas
{
    class register_response_message_handler final : public concrete_message_handler<proto::service::register_response>
    {
    public:
        using class_type = register_response_message_handler;
