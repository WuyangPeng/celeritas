...
namespace celeritas
{
    class service_auth_response_message_handler final : public concrete_message_handler<proto::service::service_auth_response>
    {
    public:
        using class_type = service_auth_response_message_handler;
        using base_type = concrete_message_handler;

        service_auth_response_message_handler();
