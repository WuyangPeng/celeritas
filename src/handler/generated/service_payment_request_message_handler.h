...
namespace celeritas
{
    class service_payment_request_message_handler final : public concrete_message_handler<proto::service::service_payment_request>
    {
    public:
        using class_type = service_payment_request_message_handler;
        using base_type = concrete_message_handler;

        service_payment_request_message_handler();
