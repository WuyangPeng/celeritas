...
celeritas::client_response_message_handler::client_response_message_handler()
{
    add_handler_function(proto::client::client_response::PayloadCase::kPlayer,
...
bool celeritas::client_response_message_handler::handle_concrete(const protobuf_handle_parameter_shared_ptr& handle_parameter, const message_type& current_message, const message_registry_weak_ptr& message_registry)
{
