...
namespace celeritas
{
    class payment_response_message_handler final : public concrete_message_handler<proto::service::payment_response>
    {
    public:
        using class_type = payment_response_message_handler;
        using base_type = concrete_message_handler;

        payment_response_message_handler();
