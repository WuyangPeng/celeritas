...
namespace celeritas
{
    class service_log_message_handler final : public concrete_message_handler<proto::service::service_log>
    {
    public:
        using class_type = service_log_message_handler;
        using base_type = concrete_message_handler;

        service_log_message_handler();
