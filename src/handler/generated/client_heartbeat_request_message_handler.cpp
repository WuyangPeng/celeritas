...
celeritas::client_heartbeat_request_message_handler::client_heartbeat_request_message_handler()
{
    add_handler_function(proto::client::client_heartbeat_request::PayloadCase::kHeartbeat,
