...
namespace celeritas
{
    class client_debug_response_message_handler final : public concrete_message_handler<proto::client::client_debug_response>
    {
    public:
        using class_type = client_debug_response_message_handler;
        using base_type = concrete_message_handler;

        client_debug_response_message_handler();
