...
namespace celeritas
{
    class client_mail_request_message_handler final : public concrete_message_handler<proto::client::client_mail_request>
    {
    public:
        using class_type = client_mail_request_message_handler;
        using base_type = concrete_message_handler;

        client_mail_request_message_handler();
