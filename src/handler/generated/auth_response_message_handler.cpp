...
celeritas::auth_response_message_handler::auth_response_message_handler()
{
    ...
    add_handler_function(proto::service::auth_response::PayloadCase::kReloadEmailProvidersDb,
                         [](const protobuf_handle_parameter& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
                             return handle_dispatch(handle_parameter, current_message, message_registry, &message_type::reload_email_providers_db);
                         });
    add_handler_function(proto::service::auth_response::PayloadCase::kReloadSdkProvidersDb,
                         [](const protobuf_handle_parameter& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
                             return handle_dispatch(handle_parameter, current_message, message_registry, &message_type::reload_sdk_providers_db);
                         });
    add_handler_function(proto::service::auth_response::PayloadCase::kReloadServerCellDb,
                         [](const protobuf_handle_parameter& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
                             return handle_dispatch(handle_parameter, current_message, message_registry, &message_type::reload_server_cell_db);
                         });
    add_handler_function(proto::service::auth_response::PayloadCase::kReloadSmsProvidersDb,
                         [](const protobuf_handle_parameter& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
