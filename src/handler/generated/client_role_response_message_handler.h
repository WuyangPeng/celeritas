...
namespace celeritas
{
    class client_role_response_message_handler final : public concrete_message_handler<proto::client::client_role_response>
    {
    public:
        using class_type = client_role_response_message_handler;
        using base_type = concrete_message_handler;

        client_role_response_message_handler();
