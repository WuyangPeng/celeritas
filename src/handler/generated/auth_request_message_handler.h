...
namespace celeritas
{
    class auth_request_message_handler final : public concrete_message_handler<proto::service::auth_request>
    {
    public:
        using class_type = auth_request_message_handler;
        using base_type = concrete_message_handler;

        auth_request_message_handler();
