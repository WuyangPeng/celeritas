...
namespace celeritas
{
    class client_auth_response_message_handler final : public concrete_message_handler<proto::client::client_auth_response>
    {
    public:
        using class_type = client_auth_response_message_handler;
        using base_type = concrete_message_handler;

        client_auth_response_message_handler();
