...
{
    add_handler_function(proto::service::service_player_request::PayloadCase::kOffline,
                         [](const protobuf_handle_parameter_shared_ptr& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
                             return handle_dispatch(handle_parameter, current_message, message_registry, &message_type::offline);
                         });
    add_handler_function(proto::service::service_player_request::PayloadCase::kReloadConfigDb,
                         [](const protobuf_handle_parameter_shared_ptr& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
    ...
    add_handler_function(proto::service::service_player_request::PayloadCase::kSendServerMail,
                         [](const protobuf_handle_parameter_shared_ptr& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
