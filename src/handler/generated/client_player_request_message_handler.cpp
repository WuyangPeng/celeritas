...
{
    add_handler_function(proto::client::client_player_request::PayloadCase::kDebug,
    ...
    add_handler_function(proto::client::client_player_request::PayloadCase::kDevelop,
                         [](const protobuf_handle_parameter_shared_ptr& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
    ...
    add_handler_function(proto::client::client_player_request::PayloadCase::kItem,
                         [](const protobuf_handle_parameter_shared_ptr& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
    ...
    add_handler_function(proto::client::client_player_request::PayloadCase::kMail,
                         [](const protobuf_handle_parameter_shared_ptr& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
                             return handle_dispatch(handle_parameter, current_message, message_registry, &message_type::mail);
                         });
    add_handler_function(proto::client::client_player_request::PayloadCase::kRedDot,
                         [](const protobuf_handle_parameter_shared_ptr& handle_parameter,
                            const message_type& current_message,
                            const message_registry_shared_ptr& message_registry) -> bool {
