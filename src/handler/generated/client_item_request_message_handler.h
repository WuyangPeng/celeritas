...
namespace celeritas
{
    class client_item_request_message_handler final : public concrete_message_handler<proto::client::client_item_request>
    {
    public:
        using class_type = client_item_request_message_handler;
        using base_type = concrete_message_handler;

        client_item_request_message_handler();
