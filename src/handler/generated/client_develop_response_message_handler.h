...
namespace celeritas
{
    class client_develop_response_message_handler final : public concrete_message_handler<proto::client::client_develop_response>
    {
    public:
        using class_type = client_develop_response_message_handler;
        using base_type = concrete_message_handler;

        client_develop_response_message_handler();
