...
namespace celeritas
{
    class develop_level_message_handler final : public player_concrete_message_handler<proto::client::develop_level_request>
    {
    public:
        using class_type = develop_level_message_handler;
        using base_type = player_concrete_message_handler;

        develop_level_message_handler() = default;
