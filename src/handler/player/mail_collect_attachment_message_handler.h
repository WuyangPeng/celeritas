...
namespace celeritas
{
    class mail_collect_attachment_message_handler final : public player_concrete_message_handler<proto::client::mail_collect_attachment_request>
    {
    public:
        using class_type = mail_collect_attachment_message_handler;
        using base_type = player_concrete_message_handler;

        mail_collect_attachment_message_handler() = default;
