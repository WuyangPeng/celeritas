...
namespace celeritas
{
    class activate_item_message_handler final : public player_concrete_message_handler<proto::client::activate_item_request>
    {
    public:
        using class_type = activate_item_message_handler;
        using base_type = player_concrete_message_handler;

        activate_item_message_handler() = default;
