...
namespace celeritas
{
    class mail_delete_all_read_message_handler final : public player_concrete_message_handler<proto::client::mail_delete_all_read_request>
    {
    public:
        using class_type = mail_delete_all_read_message_handler;
        using base_type = player_concrete_message_handler;

        mail_delete_all_read_message_handler() = default;
