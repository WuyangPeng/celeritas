...
namespace celeritas
{
    class offline_request_message_handler final : public concrete_message_handler<proto::service::offline_request>
    {
    public:
        using class_type = offline_request_message_handler;
