...
namespace celeritas
{
    class develop_claim_reward_message_handler final : public player_concrete_message_handler<proto::client::develop_claim_reward_request>
    {
    public:
        using class_type = develop_claim_reward_message_handler;
        using base_type = player_concrete_message_handler;

        develop_claim_reward_message_handler() = default;
