...
namespace celeritas
{
    class reload_config_db_message_handler final : public concrete_message_handler<proto::service::reload_config_db_request>
    {
    public:
        using class_type = reload_config_db_message_handler;
