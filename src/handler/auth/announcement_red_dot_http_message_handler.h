...
namespace celeritas
{
    class announcement_red_dot_http_message_handler final : public http_base_message_handler
    {
    public:
        using class_type = announcement_red_dot_http_message_handler;
        using base_type = http_base_message_handler;

        announcement_red_dot_http_message_handler() noexcept = default;
