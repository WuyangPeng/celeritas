...
namespace celeritas
{
    class reload_server_cell_db_message_handler final : public concrete_message_handler<proto::service::reload_server_cell_db_request>
    {
    public:
        using class_type = reload_server_cell_db_message_handler;
