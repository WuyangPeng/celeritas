...
celeritas::send_sms_http_message_handler::void_awaitable_type celeritas::send_sms_http_message_handler::response(http_handle_parameter_shared_ptr handle_parameter)
{
    try
    {
