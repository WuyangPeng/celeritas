...
namespace celeritas
{
    class password_bind_http_message_handler final : public http_base_message_handler
    {
    public:
        using class_type = password_bind_http_message_handler;
        using base_type = http_base_message_handler;

        password_bind_http_message_handler() noexcept = default;
