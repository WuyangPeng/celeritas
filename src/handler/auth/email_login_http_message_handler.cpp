...
#include "auth/email/email_login.h"
...
{
    co_spawn_response<email_login>(handle_parameter, handler_channel, "email login error:");

    return true;
}

std::string celeritas::email_login_http_message_handler::get_server_type() const
{
