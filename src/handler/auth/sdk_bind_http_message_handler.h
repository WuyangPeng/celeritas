...
namespace celeritas
{
    class sdk_bind_http_message_handler final : public http_base_message_handler
    {
    public:
        using class_type = sdk_bind_http_message_handler;
        using base_type = http_base_message_handler;

        sdk_bind_http_message_handler() noexcept = default;
