...
namespace celeritas
{
    class reload_sdk_providers_db_message_handler final : public concrete_message_handler<proto::service::reload_sdk_providers_db_request>
    {
    public:
        using class_type = reload_sdk_providers_db_message_handler;
