...
celeritas::password_login_http_message_handler::void_awaitable_type celeritas::password_login_http_message_handler::response(http_handle_parameter_shared_ptr handle_parameter)
{
    try
    {
