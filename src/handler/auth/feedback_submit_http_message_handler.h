...
namespace celeritas
{
    class feedback_submit_http_message_handler final : public http_base_message_handler
    {
    public:
        using class_type = feedback_submit_http_message_handler;
        using base_type = http_base_message_handler;

        feedback_submit_http_message_handler() noexcept = default;
