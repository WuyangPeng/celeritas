...
#include "auth/phone/phone_login.h"
...
{
    co_spawn_response<phone_login>(handle_parameter, handler_channel, "phone login error:");

    return true;
}

std::string celeritas::phone_login_http_message_handler::get_server_type() const
{
