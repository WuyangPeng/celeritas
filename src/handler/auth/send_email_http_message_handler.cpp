...
{
    co_spawn_response<send_email>(handle_parameter, handler_channel, "send email error:");

    return true;
}

std::string celeritas::send_email_http_message_handler::get_server_type() const
{
