...
bool celeritas::send_email_http_message_handler::handle(const http_handle_parameter_shared_ptr& handle_parameter,
...
celeritas::send_email_http_message_handler::void_awaitable_type celeritas::send_email_http_message_handler::response(http_handle_parameter_shared_ptr handle_parameter)
{
    try
    {
