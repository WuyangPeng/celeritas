...
namespace celeritas
{
    class admin_login_http_message_handler final : public http_base_message_handler
    {
    public:
        using class_type = admin_login_http_message_handler;
        using base_type = http_base_message_handler;

        admin_login_http_message_handler() noexcept = default;
