...
namespace celeritas
{
    class announcement_admin_create_http_message_handler final : public http_base_message_handler
    {
    public:
        using class_type = announcement_admin_create_http_message_handler;
        using base_type = http_base_message_handler;

        announcement_admin_create_http_message_handler() noexcept = default;
