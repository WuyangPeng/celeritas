...
namespace celeritas
{
    class gateway_request_message_handler final : public concrete_message_handler<proto::request>
    {
    public:
        using class_type = gateway_request_message_handler;
        using base_type = concrete_message_handler;

        gateway_request_message_handler();
