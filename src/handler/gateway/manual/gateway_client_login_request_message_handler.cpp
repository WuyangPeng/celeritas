...
bool celeritas::gateway_client_login_request_message_handler::handle_concrete(const protobuf_handle_parameter_shared_ptr& handle_parameter, const message_type& current_message, const message_registry_weak_ptr& message_registry)
{
    ...
    {
        case proto::client::client_login_request::PayloadCase::PAYLOAD_NOT_SET:
        {
            return false;
        }
        // 转发到其他服务器
