...
namespace celeritas
{
    class gateway_client_login_request_message_handler final : public concrete_message_handler<proto::client::client_login_request>
    {
    public:
        using class_type = gateway_client_login_request_message_handler;
        using base_type = concrete_message_handler;

        gateway_client_login_request_message_handler();
