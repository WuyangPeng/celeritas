...
namespace celeritas
{
    class gateway_service_login_response_message_handler final : public concrete_message_handler<proto::service::service_login_response>
    {
    public:
        using class_type = gateway_service_login_response_message_handler;
        using base_type = concrete_message_handler;

        gateway_service_login_response_message_handler();
