...
namespace celeritas
{
    class kill_monster_progress_calculator final : public default_progress_calculator
    {
    public:
        using base_type = default_progress_calculator;

        explicit kill_monster_progress_calculator(player_state* player_state) noexcept;
