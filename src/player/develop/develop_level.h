...
namespace celeritas
{
    class develop_level : public player_service_base
    {
    public:
        using class_type = develop_level;
        using base_type = player_service_base;
        using request_type = proto::client::develop_level_request;
        using develop_level_shared_ptr = std::shared_ptr<class_type>;

        [[nodiscard]] static develop_level_shared_ptr create(protobuf_handle_parameter_shared_ptr handle_parameter,
                                                             player_state_shared_ptr player_state,
                                                             request_type request);

        develop_level(protobuf_handle_parameter_shared_ptr handle_parameter,
                      player_state_shared_ptr player_state,
                      request_type request);
