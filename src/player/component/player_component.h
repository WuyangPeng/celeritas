...
namespace celeritas
{
    ...
    public:
        ...
        // 默认定时器回调
        [[nodiscard]] virtual void_awaitable_type time_callback(const player_time_refresh_key& player_time_refresh_key, bool is_login);
 ...
 [[nodiscard]] database_pool_shared_ptr get_mongo_admin_database_pool();
