...
namespace celeritas
{
    class player_null_component final : public player_component
    {
    public:
        using class_type = player_null_component;
        using base_type = player_component;

        explicit player_null_component(player_state* player_state) noexcept;
