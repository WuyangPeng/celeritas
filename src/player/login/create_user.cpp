...
celeritas::create_user::create_user(protobuf_handle_parameter protobuf_handle_parameter, const proto::service::service_login_request& login)
    : protobuf_handle_parameter_{ std::move(protobuf_handle_parameter) }, login_{ login }
{
}

celeritas::create_user::optional_user_awaitable_type celeritas::create_user::send_message() const
{
