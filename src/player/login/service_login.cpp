...
celeritas::service_login::void_awaitable_type celeritas::service_login::send_message() const
{
    ...
    const auto player = player_manager::get_instance().add_player(*user, protobuf_handle_parameter_->get_resource_loader(), protobuf_handle_parameter_->get_io_context(), protobuf_handle_parameter_->get_instance_id());
