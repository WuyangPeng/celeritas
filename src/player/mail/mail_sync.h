...
namespace celeritas
{
    class mail_sync : public player_service_base
    {
    public:
        using class_type = mail_sync;
        using base_type = player_service_base;
        using request_type = proto::client::mail_request;
        using mail_sync_shared_ptr = std::shared_ptr<class_type>;

        [[nodiscard]] static mail_sync_shared_ptr create(protobuf_handle_parameter_shared_ptr handle_parameter,
                                                         player_state_shared_ptr player_state,
                                                         request_type request);

        mail_sync(protobuf_handle_parameter_shared_ptr handle_parameter,
                  player_state_shared_ptr player_state,
                  request_type request);
