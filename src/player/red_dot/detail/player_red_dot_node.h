...
namespace celeritas
{
    ...
    private:
        ...
        void init_red_dot_node(const config::game::red_dot_config_container& container);

        void set_red_dot_node_association(const config::game::red_dot_config_container& container);
