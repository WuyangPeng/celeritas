...
namespace celeritas
{
    ...
    private:
        ...
        using red_container_type = container_config<red_dot_config, red_dot_type>::container;
        using const_red_dot_config_shared_ptr = std::shared_ptr<const red_dot_config>;
        ...
        void init_red_dot_node(const red_container_type& container);

        void set_red_dot_node_association(const red_container_type& container);
