...
namespace celeritas
{
    ...
    public:
        ...
        using item_selected_shared_ptr = std::shared_ptr<class_type>;

        [[nodiscard]] static item_selected_shared_ptr create(protobuf_handle_parameter_shared_ptr handle_parameter,
