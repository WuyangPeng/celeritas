...
namespace celeritas
{
    class unlock_item : public player_service_base
    {
    public:
        using class_type = unlock_item;
        using base_type = player_service_base;
        using request_type = proto::client::unlock_item_request;
        using unlock_item_shared_ptr = std::shared_ptr<class_type>;

        [[nodiscard]] static unlock_item_shared_ptr create(protobuf_handle_parameter_shared_ptr handle_parameter,
