...
namespace celeritas
{
    class player_red_component final : public player_component
    {
    public:
        using class_type = player_red_component;
        using base_type = player_component;

        explicit player_red_component(player_state* player_state) noexcept;
