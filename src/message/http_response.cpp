...
celeritas::http_response celeritas::tag_invoke(boost::json::value_to_tag<http_response>, const boost::json::value& value)
{
    const auto& object = value.as_object();

    try
    {
        const auto code = static_cast<game_error_type>(boost::json::value_to<int>(object.at(http_response::code_description)));
        auto message = boost::json::value_to<std::string>(object.at(http_response::message_description));
...
void celeritas::tag_invoke(boost::json::value_from_tag, boost::json::value& value, const http_response& http_response)
{
    value = {
